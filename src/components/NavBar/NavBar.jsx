...
>
  My Cart 
    ...
    return (
        <div className=" bg-[#331D2C]  w-full">
            
            <div className="navbar md:container md:mx-auto   w-full h-20">
  ...
  <div className="navbar-start">
    ...
    <div className=" normal-case text-5xl font-black flex gap-3 md:flex-row-reverse">
      <img className=" md:w-44 w-32" src="https://i.ibb.co/GHVKhQz/Screenshot-2023-10-17-200415.png" alt="" />
      <label className="swap swap-rotate">
  
  {/* this hidden checkbox controls the state */}
  <input checked={theme==="light"? false : true} onChange={handleMode} type="checkbox" />
