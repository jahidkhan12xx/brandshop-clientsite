...
const BrandDetailsFull = ({prod}) => {
  ...
  return (
    <div>
        <div className="card card-side bg-base-100 shadow-xl flex h-full">
  <figure className=" w-1/2"><img className=" w-full h-full" src={prod.product_img} alt="Movie"/></figure>
  <div className="card-body flex w-1/2">
    ...
    <p>Ratings: {prod.product_rating}</p>
